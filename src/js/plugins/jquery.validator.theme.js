...
+(function($) {
  ...
  if ($.validator) {
    const fixedLeft = ($msgbox) => {
      const $input = $msgbox.prev()
      let $btngroup = $msgbox.next()
      const $icheck = $msgbox.closest('[data-icheck]')
      const $ichecks = $icheck.siblings('[data-icheck="' + $icheck.data('icheck') + '"]').addBack()
      const $upload = $msgbox.closest('.bjui-upload')
    ...
    $.validator.setTheme({
      'simple_right': {
        ...
        msgShow: function($msgbox, type) {
          ...
          var fW = $form.width()
          var fL = $form.offset().left
          var eL = $msgbox.offset().left
          var mw = $el.outerWidth()
