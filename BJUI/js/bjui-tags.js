  ...
  Tags.prototype.TOOLS = function() {
    ...
    return {
      ...
      keyUp: function(e) {
        ...
        switch (e.which) {
          ...
          case BJUI.keyCode.DOWN:
            ...
            $highlight = that.$menu.find('> .' + options.lightCls)

            var $first = that.$menu.find('> li:first-child')
          ...
          case BJUI.keyCode.UP:
            ...
            var $last = that.$menu.find('> li:last-child')
      ...
      doQuery: function() {
        ...
        var term = that.$element.val()
        var $menu = that.$box.find('> .tags-menu')
        var tags = []
        var $item = null
